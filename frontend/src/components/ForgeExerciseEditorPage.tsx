...
import type { ForgeEquipment, ForgeExerciseInput, ForgeLoadBasis, ForgeLoadingSystem, ForgeMachineProfile } from '../api/api';

const SAND = '#e8c58a'; const TEXT = '#f2ece0'; const DIM = 'rgba(242,236,226,0.48)'; const BORDER = 'rgba(232,197,138,0.11)';
const LOADING_LABELS: Record<ForgeLoadingSystem, string> = { selectorized: 'Steckgewicht', plate_loaded: 'Scheibenbeladen', fixed: 'Feste Last', other: 'Sonstiges', unknown: 'Ladeprinzip unbekannt' };
const BASIS_LABELS: Record<ForgeLoadBasis, string> = { displayed_total: 'Gesamtgewicht', per_side: 'Je Seite', unknown: 'Lastbasis unbekannt' };
const formatProfileWeight = (value: number) => new Intl.NumberFormat('de-DE', { maximumFractionDigits: 3 }).format(value);
